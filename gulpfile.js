...
/*
 ...
 |--------------------------------------------------------------------------
 */
gulp.task('vendor', function() { // 将所有第三方JS文件合并到一个文件
  return gulp.src([
...
/*
 ...
 |--------------------------------------------------------------------------
 */
gulp.task('browserify-vendor', function() { // 因为性能原因，我们将NPM模块和前端模块分开编译和打包，因此每次重新编译将会快个几百毫秒
  return browserify()
...
gulp.task('watch', function() { // 当文件改变时重新编译LESS文件
